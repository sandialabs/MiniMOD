...
/* 
 * Kernel gran bench
 * This is a basic communication benchmark that communicates via the granularity component. It runs two tests, 
 * the first is a "fine grained test" that calls the module with a number of sub-elements (splitting the 
 * communication into smaller grained pieces. The second is a "bulk test" that sends one large message.
 *
